...
train_datas = preprocessing.binarize(train_data)
train_targets = preprocessing.binarize(train_target)
test_datas = preprocessing.binarize(test_data)
test_targets = preprocessing.binarize(test_target)

# DCTC - 100 - 56 -accu dtc1
# RFC - 10 -59 - accu dtc
# GBC - 2 - 52 - accu gbc
# LGR - - 55 - accu log
